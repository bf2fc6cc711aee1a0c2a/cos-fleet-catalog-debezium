...
COPY --from=builder --chown=1001 /javabuild/target/quarkus-app/lib/ /deployments/lib/
COPY --from=builder --chown=1001 /javabuild/target/quarkus-app/*.jar /deployments/
COPY --from=builder --chown=1001 /javabuild/target/quarkus-app/app/ /deployments/app/
COPY --from=builder --chown=1001 /javabuild/target/quarkus-app/quarkus/ /deployments/quarkus/
